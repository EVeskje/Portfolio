    ...
    <section className="section">
      <div className="container grid items-center gap-8 md:grid-cols-2">
        <div>
          ...
          <h1 className="mt-3 text-3xl font-extrabold leading-tight md:text-5xl">Hi, I’m Eirik — I build clean, accessible interfaces.</h1>
        ...
        <div className="relative place-self-center">
          <img
            ...
            loading="eager"
          />
          <div className="pointer-events-none absolute -bottom-3 -left-3 h-36 w-36 rounded-full blur-2xl" style={{
            background: 'radial-gradient(circle at 30% 30%, #60a5fa, transparent 60%), radial-gradient(circle at 70% 70%, #a78bfa, transparent 60%)', opacity: .55
          }} />
        </div>
      </div>
    </section>
